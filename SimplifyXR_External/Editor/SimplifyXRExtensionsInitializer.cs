...
namespace SimplifyXR
{
    ...
    {
        public void AddARFoundationAdapterComponent(GameObject contentHolder, bool TrackAllTargetsInDatabase, string IndividualTargetToTrack, ScriptableObject imageDatabase, GameObject sessionOrigin)
        {
#if USING_ARFOUNDATION
